    text =
    {
        ...
        ALREADY_OBTAINED_TELE        = 7338,  -- You already possess the gate crystal for this telepoint.
        TELEPOINT_DISAPPEARED        = 7339,  -- The telepoint has disappeared...
        SIGN_1                       = 7413,  -- North: Meriphataud Mountains Northeast: Crag of Mea South: East Sarutabaruta
        SIGN_3                       = 7414,  -- North: Meriphataud Mountains East: Crag of Mea South: East Sarutabaruta
        SIGN_5                       = 7415,  -- North: Meriphataud Mountains East: Buburimu Peninsula South: East Sarutabaruta
        SIGN_7                       = 7416,  -- East: Buburimu Peninsula West: East Sarutabaruta
        BUD_BREAKS_OFF               = 7417,  -- The bud breaks off. You obtain <item>.
        POISONOUS_LOOKING_BUDS       = 7418,  -- The flowers have poisonous-looking buds.
        CANT_TAKE_ANY_MORE           = 7419,  -- You can't take any more.
        MINING_IS_POSSIBLE_HERE      = 7440,  -- Mining is possible here if you have <item>.
