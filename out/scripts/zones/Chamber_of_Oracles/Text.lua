    text =
    {
        ...
        PLACED_INTO_THE_PEDESTAL         = 7629, -- It appears that something should be placed into this pedestal.
        YOU_PLACE_THE                    = 7630, -- You place the <item> into the pedestal.
        IS_SET_IN_THE_PEDESTAL           = 7631, -- The <item> is set in the pedestal.
        HAS_LOST_ITS_POWER               = 7632, -- The <item> has lost its power.
        DOOR_IS_FIRMLY_SHUT              = 7633, -- The door is firmly shut.
