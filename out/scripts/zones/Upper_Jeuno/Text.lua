    text =
    {
        ...
        HOMEPOINT_SET                    = 6684,  -- Home point set!
        MOG_LOCKER_OFFSET                = 6802,  -- Your Mog Locker lease is valid until <timestamp>, kupo.
        GLYKE_SHOP_DIALOG                = 6985,  -- Can I help you?
        MEJUONE_SHOP_DIALOG              = 6986,  -- Welcome to the Chocobo Shop.
        VIETTES_SHOP_DIALOG              = 6987,  -- Welcome to Viette's Finest Weapons.
        DURABLE_SHIELDS_SHOP_DIALOG      = 6988,  -- Welcome to Durable Shields.
        MP_SHOP_DIALOG                   = 6989,  -- Welcome to M & P's Market.
        GUIDE_STONE                      = 6990,  -- Up: Ru'Lude Gardens Down: Lower Jeuno (facing Bastok)
        IT_READS_STAFF_ONLY              = 6992,  -- It reads, Staff Only.
        LEILLAINE_SHOP_DIALOG            = 7015,  -- Hello. Are you feeling all right?
        YOU_CAN_NOW_BECOME_A_BEASTMASTER = 7195,  -- You can now become a beastmaster.
