    text =
    {
        ...
        ALL_G_ORBS_ENERGIZED     = 7265,  -- The six Mana Orbs have been successfully energized with magic!
        CHEST_UNLOCKED           = 7288,  -- You unlock the chest!
        CANNOT_ENTER_BATTLEFIELD = 7349,  -- You cannot enter this battlefield with the key item: <keyitem> in your possession.
