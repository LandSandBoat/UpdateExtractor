    text =
    {
        ...
        RLB_LAND                      = 7636, -- ...Return to the hell you crawled out from!
        SAVAGE_PREPARE                = 7637, -- The anger, the pain, and the will to survive... Let the spirit of San d'Oria converge within this blade.
        SAVAGE_LAND                   = 7638, -- And with this blade I will return the glory to my kingdom's people!
        ...
        PROMISE_ME_YOU_WONT_GO_DOWN   = 8015, -- Promise you won't go down too easy, okay?
        IM_JUST_GETTING_WARMED_UP     = 8016, -- Haha! I'm just getting warmed up!
        YOU_PACKED_MORE_OF_A_PUNCH    = 8017, -- Hah! You pack more of a punch than I thoughtaru. But I won't go down as easy as old Maat!
        WHATS_THIS_STRANGE_FEELING    = 8018, -- What's this strange feeling...? It's not supposed to end...like...
