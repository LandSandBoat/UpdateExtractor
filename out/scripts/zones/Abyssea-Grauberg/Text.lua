    text =
    {
        ...
        OBTAINS_DOMINION_NOTES        = 7877,  -- <name> obtains <number> Dominion note[/s] (Total: <number>).
        DOMINION_SIGNED_ON            = 10413, -- You have signed on for Dominion Ops!
        CANCELED_OBJECTIVE            = 10414, -- You have canceled your objective.
    },
