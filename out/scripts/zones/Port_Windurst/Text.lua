    text =
    {
        ...
        GUILD_TERMINATE_CONTRACT        = 11706, -- You have terminated your trading contract with the [Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild and formed a new one with the [Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild.
        GUILD_NEW_CONTRACT              = 11714, -- You have formed a new trading contract with the [Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild.
        NO_MORE_GP_ELIGIBLE             = 11721, -- You are not eligible to receive guild points at this time.
        GP_OBTAINED                     = 11726, -- Obtained: <number> guild points.
        NOT_HAVE_ENOUGH_GP              = 11727, -- You do not have enough guild points.
        RYAN_SHOP_DIALOG                = 11841, -- I have no time for white-livered scum that rely on magic alone. If you're with me then check out these wares from across the high seas.
        DROZGA_SHOP_DIALOG              = 11842, -- Ho there, young [man/lady]! Not only is Ryan a boorish lout, but his craftsmanship leaves much to be desired, as well. You're better off buyin' from me.
        CONQUEST                        = 11908, -- You've earned conquest points!
        KOHLO_LAKOLO_DIALOG_A           = 12451, -- On your Star Onion Brigade honor, you can't tell anybody that Joker is hiding in the ghosty house!
        LEBONDUR_OPEN_DIALOG            = 12562, -- I've risked my life traveling all the way from Vollbow to bring you these fine goods!
        LEBONDUR_CLOSED_DIALOG          = 12563, -- Where is my shipment from Vollbow? This is terrible for my image as a respected importer...
        SATTSUHAHKANPARI_OPEN_DIALOG    = 12564, -- You can look, but don't touch! And rememberrr, you break it, you bought it!
        SATTSUHAHKANPARI_CLOSED_DIALOG  = 12565, -- You've heard of the Elshimo Uplands, haven't you? Well, if you'll hold on a minute, I'll have a shipment of goods coming in any time now.
        BLACK_HALO_LEARNED              = 12661, -- You have learned the weapon skill Black Halo!
        KUCHAMALKOBHI_SHOP_DIALOG       = 12710, -- How about a nice suit of adventurer-issue armorrr? Be careful though. We offer no rrrefunds!
        ALIZABE_OPEN_DIALOG             = 12890, -- Don't tell anybody, but I've managed to get my hands on some items from Tavnazia! Take a look!
        ALIZABE_CLOSED_DIALOG           = 12891, -- Pssst! Have you heard of Tavnazia? Boy, do they have some sweet items on those islands...
        ALIZABE_COP_NOT_COMPLETED       = 12892, -- It won't be long before I set up shop right here in this very place. And once I start, there won't be no stoppin' me!
        RETRIEVE_DIALOG_ID              = 15901, -- You retrieve <item> from the porter moogle's care.
        OBTAINED_NUM_KEYITEMS           = 15943, -- Obtained key item: <number> <keyitem>!
