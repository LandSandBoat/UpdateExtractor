    text =
    {
        ...
        TITAN_UNLOCKED                   = 7580, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ATTACH_SEAL                      = 7732, -- <player> attaches <item> to the protocrystal.
        POWER_STYMIES                    = 7733, -- An unseen power stymies your efforts to attach <item> to the protocrystal.
    },
