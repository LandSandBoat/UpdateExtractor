    text =
    {
        ...
        NOTHING_HAPPENS               = 8075, -- Nothing happens.
        PERHAPS_THE_WISEST            = 8076, -- Perhaps the wisest approach would be to search for <keyitem> with which to open the decrepit sluice gate.
