    text =
    {
        ...
        SOMETHING_BURRIED             = 7323,  -- It looks like something was buried here.
        ...
        REGIME_REGISTERED             = 9699,  -- New training regime registered!
        COMMON_SENSE_SURVIVAL         = 10818, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
