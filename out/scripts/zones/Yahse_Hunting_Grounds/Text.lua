    text =
    {
        ...
        WAYPOINT_ATTUNED           = 7608, -- Your <keyitem> has been attuned to a geomagnetic fount[/ at the frontier station/ at Frontier Bivouac #1/ at Frontier Bivouac #2/ at Frontier Bivouac #3]!
        EXPENDED_KINETIC_UNITS     = 7623, -- You have expended <number> kinetic unit[/s] and will be transported to another locale.
        INSUFFICIENT_UNITS         = 7624, -- Your stock of kinetic units is insufficient.
        REACHED_KINETIC_UNIT_LIMIT = 7625, -- You have reached your limit of kinetic units and cannot charge your artifact any further.
        CANNOT_RECEIVE_KINETIC     = 7626, -- There is no response. You apparently cannot receive kinetic units from this item.
