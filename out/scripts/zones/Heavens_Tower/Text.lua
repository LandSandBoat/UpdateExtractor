    text =
    {
        ...
        CELEBRATORY_GOODS             = 9111, -- An assortment of celebratory goods is available for purchase.
        OBTAINED_NUM_KEYITEMS         = 9189, -- Obtained key item: <number> <keyitem>!
        NOT_ACQUAINTED                = 9191, -- I'm sorry, but I don't believe we're acquainted. Please leave me be.
    },
