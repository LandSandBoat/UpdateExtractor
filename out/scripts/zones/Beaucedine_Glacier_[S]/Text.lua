    text =
    {
        ...
        NONDESCRIPT_MASS              = 7762, -- A nondescript mass squirms hypnotically beneath the rock.
        REMAINS_OF_COOKFIRE           = 7786, -- You see the charred remains of a cookfire.
        UNWANTED_ATTENTION            = 8587, -- Your presence has drawn unwanted attention!
        UNUSUAL_PRESENCE              = 8589, -- You sense an unusual presence in the area...
        ...
        VOIDWALKER_SPAWN_MOB          = 8668, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 8670, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 8671, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 8672, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 8673, -- Obtained key item: <keyitem>!
