    text =
    {
        ...
        DEVICE_IN_OPERATION     = 7238, -- The device appears to be in operation...
        DOOR_LOCKED             = 7241, -- The door is locked.
        ...
        TRAP_ACTIVATED          = 7253, -- <name> examines the stone compartment. A trap connected to it has been activated!
        CHEST_UNLOCKED          = 7471, -- You unlock the chest!
        BROKEN_KNIFE            = 7479, -- A broken knife blade can be seen among the rubble...
        HOMEPOINT_SET           = 7484, -- Home point set!
    },
