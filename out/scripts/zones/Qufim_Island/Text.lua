    text =
    {
        ...
        GARRISON_BASE                  = 7763,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        GIGANTIC_FOOTPRINT             = 7842,  -- There is a gigantic footprint here.
        ASA_SNOW                       = 7855,  -- You see the following words scrawled into the snow: Shantotto Empire Provisional Headquarters.
        ...
        UNITY_WANTED_BATTLE_INTERACT   = 8136,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED              = 10350, -- New training regime registered!
        LEARNS_SPELL                   = 12668, -- <name> learns <spell>!
        UNCANNY_SENSATION              = 12670, -- You are assaulted by an uncanny sensation.
