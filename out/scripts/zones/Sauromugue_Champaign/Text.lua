    text =
    {
        ...
        REGIME_REGISTERED             = 9817,  -- New training regime registered!
        VOIDWALKER_NO_MOB             = 10990, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 10991, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 10992, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 10993, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 10995, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 10996, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 10997, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 10998, -- Obtained key item: <keyitem>!
        LEARNS_SPELL                  = 12498, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12500, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 12507, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
