    text =
    {
        ...
        OLD_SABERTOOTH_DIALOG_II = 7245,  -- The sound of the tiger's footsteps is growing louder.
        ...
        THF_AF_MOB               = 7423,  -- Something has come down from the tower!
        THF_AF_WALL_OFFSET       = 7442,  -- It is impossible to climb this wall with your bare hands.
